...
class CustomUser(AbstractBaseUser):
    ...
    image = models.ImageField(verbose_name="User Image", upload_to='users/%Y/%m', null=True, blank=True)
    spotify_id = models.CharField(verbose_name="Spotify ID", max_length=255, unique=True, null=True, blank=True)
    ...
    access_token = models.CharField(verbose_name="Access Token", max_length=400, null=True, blank=True)
